                        ...
                        <ul class="nav-right">
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    <img src="../assets/images/placeholder.jpg" class="img-radius" alt="User-Profile-Image">
                                    <span>Admin</span>
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="../assets/images/placeholder.jpg" alt="User-Profile-Image">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        ...
                                        <span class="pcoded-mtext">Races</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="pcoded-hasmenu">
                                    <a href="javascript:void(0)" class="waves-effect waves-dark">
                                        <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i><b>BC</b></span>
                                        <span class="pcoded-mtext">Voting</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                    <ul class="pcoded-submenu">
                                        <li class=" ">
                                            <a href="{{ route('listvotes') }}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">View Voting</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li class=" ">
                                            <a href="{{ route('addvote') }}" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Add Voting</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="">
                                            <a href="sample-page.html" class="waves-effect waves-dark">
                                                ...
                                                <span class="pcoded-mtext">Setiings</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb">
                                            <li class="breadcrumb-item">
                                                <a href="{{ route('listraces') }}"> <i class="fa fa-home"></i> </a>
                                            </li>
